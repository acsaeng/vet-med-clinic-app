...
public class RequestController {
	...
	/**
	 * Send request to add a request for an animal.
	 ...
	 * @param strId - the ID of the requested request
	...
	public Request selectRequestById(@PathVariable("id") String strId) {
		try {
            ...
            return requestService.selectRequestById(id)
	...
	/**
	 * Delete an existing request in the database.
	 * Checks that the request ID is valid.
