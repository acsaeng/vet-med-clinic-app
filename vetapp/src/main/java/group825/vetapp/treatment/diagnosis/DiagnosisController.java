...
public class DiagnosisController {
	...
	/**
	 * Send request to add a diagnosis for an animal.
	...
	/**
	 * Displays all the diagnosiss associated with an animal
	 * @return a list of all the diagnosiss
	 */
	@GetMapping
	...
	/**
	 * Delete an existing diagnosis in the database.
	 * Checks that the diagnosis ID is valid.
